...
class mouseTracker(_mouseTracker):
    def __init__(self):
        ...
        self.FakeMouseEvent = eventInfo(x=2, y=2)
        self.FakeMouseEvent.x = 0
    
    def SetMouseStateReporter(self, display):
        self.ReportMouseState = display.ReportMouseState

    def SetFakeLeftMouseDown(self):
        self.leftDown()
        self.ReportMouseState()
        evt.Skip() # to permit setting focus

    def OnFakeLeftMouseUp(self, evt):
        self.leftUp()
        self.ReportMouseState()

    def OnFakeRightMouseDown(self, evt):
        self.rightDown()
        self.ReportMouseState()
        evt.Skip() # to permit setting focus

    def OnFakeRightMouseUp(self, evt):
        self.rightUp()
        self.ReportMouseState()
...
class eventInfo(object):
    ...
    produces an object with x, y and time attributes set accordingly.
