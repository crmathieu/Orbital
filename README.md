...
For hassle free install, it is recommended to do the manual installation instead of using the pip command. This 
will garantee to install libraries compatible with python 2.7 and vpython 6.5. Simply go to the "manual-install" folder:
```text
vis.zip
Polygon.zip
cv2.zip
